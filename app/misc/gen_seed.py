...
def generate_id() -> str:
    """
    Generates a unique identifier consisting of 3 uppercase letters and 3 digits,
    alternating between letters and digits. The generated identifier does not contain
